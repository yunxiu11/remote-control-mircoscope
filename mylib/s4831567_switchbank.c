...
QueueHandle_t s4831567QueueSwitchbank;
...
{
    s4831567_reg_switchbank_init();
    s4831567QueueSwitchbank = xQueueCreate(5, sizeof(s4831567SwitchbankMsg));
    s4831567SwitchbankMsg msg;

    for (;;)
    {
        msg.switch_val = s4831567_reg_switchbank_read();
        xQueueSend(s4831567QueueSwitchbank, &msg, portMAX_DELAY);
...
{
    xTaskCreate((void *)&s4831567TaskSwitchbank, "SWTask", 256, NULL, 2, NULL);
}