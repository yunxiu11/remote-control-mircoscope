 ...
 *          s4831567_rcmext_init() - Initialise RCMEXT task
 *          s4831567_rcmext_handle_command() - Handle RCMEXT command
 *          s4831567_rcmext_task() - RCMEXT task
 ******************************************************************************/
...
void s4831567_rcmext_handle_command(uint8_t opcode)
{
    switch (opcode)
    {
    case CMD_OPCODE_NEW:
...
void s4831567_rcmext_init(void)
{
