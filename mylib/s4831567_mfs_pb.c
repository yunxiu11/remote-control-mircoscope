...
SemaphoreHandle_t s4831567SemaphoreS1;
SemaphoreHandle_t s4831567SemaphoreS2;
SemaphoreHandle_t s4831567SemaphoreS3;
...
void s4831567_reg_mfs_pb_isr(int pbSelect)
{
    ...
    if ((current_time - last_debounce_time[pbSelect]) > debounce_delay)
    {
        ...
        if (pbSelect == 0 && s4831567SemaphoreS1 != NULL)
        {
            xSemaphoreGiveFromISR(s4831567SemaphoreS1, &xHigherPriorityTaskWoken);
        }
        else if (pbSelect == 2 && s4831567SemaphoreS3 != NULL)
        {
            xSemaphoreGiveFromISR(s4831567SemaphoreS3, &xHigherPriorityTaskWoken);
        }
...
{
    s4831567SemaphoreS1 = xSemaphoreCreateBinary();
    s4831567SemaphoreS3 = xSemaphoreCreateBinary();
    onboardBtnSemaphore = xSemaphoreCreateBinary();

    s4831567_reg_mfs_pb_init(0);
    s4831567_reg_mfs_pb_init(2);
    s4831567_reg_mfs_pb_init(3);
}
